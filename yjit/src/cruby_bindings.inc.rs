...
pub const YARVINSN_sendforward: ruby_vminsn_type = 57;
pub const YARVINSN_opt_send_without_block: ruby_vminsn_type = 58;
...
pub const YARVINSN_opt_case_dispatch: ruby_vminsn_type = 74;
...
pub const YARVINSN_trace_newarraykwsplat: ruby_vminsn_type = 136;
...
pub const YARVINSN_trace_opt_case_dispatch: ruby_vminsn_type = 182;
